...
% sensorcfg1.pd = 1.0;
% sensorcfg1.stdang = 2*pi/180*0 + 1.e-5;
% sensorcfg1.stdrange = 10*0 + 1.e-5; % 25;
% sensorcfg1.stdrangerate = 1*0 + 1.e-5;
...
% save rbrrsensortestdata2.mat sim simcfg Xt

% % Now initiate a filter and run it

load rbrrsensortestdata.mat
sensorObj  =  sim.platforms{4}.sensors{1};
