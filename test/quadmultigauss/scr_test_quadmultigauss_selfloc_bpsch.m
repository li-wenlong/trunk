...
[localposteriors, logsis, sidists, localpriors, assocs ] = fun_kalmanfiltersenswassoc( sensors, filters );
...
for l=1:size(E,1)
    ...
    myedgecfg.postis = localposteriors( timewindow, nodei );
    myedgecfg.predis = localpriors( timewindow, nodei );
    
    myedgecfg.postjs = localposteriors( timewindow, nodej );
    ...
    myedgecfg.associ = assocs(  timewindow, nodei  );
    myedgecfg.assocj = assocs(  timewindow, nodej  );
