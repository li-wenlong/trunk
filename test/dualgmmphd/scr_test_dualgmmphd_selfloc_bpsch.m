...
for l=1:size(E,1)
    ...
    myedgecfg.updatefun = @dualedgepotupdate;
    myedgecfg.updateparams = {1/1000, 1/1000, 1/1000, 1/100, 1/100, 1/100,1/25,1/25,1/25,...
        1/10,1/10,1/10,1/4,1/4,1/4,1,1,1}; % A buffer for parameters to be passed to update at each occasion
