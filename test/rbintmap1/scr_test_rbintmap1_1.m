...
% 
% save rbintmap_testdata1.mat sim simcfg Xt

% % % % Now initiate a filter and run it
% % % 
load rbintmap_testdata1.mat

sensorObj = sim.platforms{2}.sensors{1};
sensorObj.signalpower = 1.0;
sensorObj.betasquare = 0.1;
...
filtercfg.numpartnewborn = 81;% 225; % Number of particles per pixel for testing new born targets
