...
[initgrid_x,initgrid_y] = meshgrid([-1500:gridcellwidth:2500],...
    [-1500:gridcellwidth:2500]);
...
[localposteriors_, logsis, sidists, localpriors_ ] = fun_gmphdfiltersens( sensors, filters );
...
for ecnt = 1:length(E)
    ...
    for k=1:numsamples
        ...
        for tcnt = 1:length( timewindow )
            ...
            trmod = localpriors{ tcnt ,nodej}; % This is the local posterior transmitted in the previous step
            ...
            trconf.s.gmm.pdfs = cotranx2y( trconfgmm.pdfs, [ theta_ij(1,k); theta_ij(2,k)], [0;0] );             
