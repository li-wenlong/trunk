...
% save bearingsensortestdata2.mat sim simcfg Xt

% Now initiate a filter and run it

load bearingsensortestdata2.mat
...
bias1 = bearingmeas;
bias1.bearing = -6*pi/180 -(-0.085956005054777);

bias2 = bearingmeas;
bias2.bearing = 2*pi/180 - (0.028196461722890);

bias3 = bearingmeas;
bias3.bearing = -2*pi/180 - ( -0.028439778752771);


sensorObj1.biasbuffer(bias1);
sensorObj2.biasbuffer(bias2);
sensorObj3.biasbuffer(bias3);
