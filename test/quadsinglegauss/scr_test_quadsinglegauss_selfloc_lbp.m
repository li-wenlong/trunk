...
mypmrfcfg.euschedule = {E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E};
mypmrfcfg.itermax = 30;
...
for l=2:length( V ) 
    p0s( l ) = cpdf( gk( eye(dims)*40000, Thetas(l,:)) );
end

mynodecfg = pbnodecfg;
numsamples = 100;
mynodecfg.state = particles('states', p0s(1).gensamples(numsamples),'labels', 1 );
