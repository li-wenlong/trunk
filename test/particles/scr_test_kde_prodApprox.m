...
kp = kde(rand(2,sampsize), 1 );
%kp = productApprox( kp, {k1,k2},{},{}, 'epsilon',1e-200 ) ;
%kp = productApprox(  kp, {k1,k2}, {},{}, 'gibbsMS1', 10 ) ;
kp = productApprox( kp, {k1,k2} , {},{}, 'importPair', 2 ) ;
%kp = productApprox( kp, {k1,k2} , {},{}, 'import', 2 ) ;
