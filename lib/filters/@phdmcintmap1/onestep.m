...
% Get the new born particles; the sum of the weights is needed in the update of the o particle
this = this.nbpart( sensors , regs );

% Predict
this = this.predict(sensors(1));
...
% The function findparlhood below is not implemented for the intensity map sensor, yet
