function varargout = getpdprofile(this, varargin )

pstate = kstate;
pstate.setstatelabels({'x','y','z','psi','theta','phi'});
pstate.substate([0 0 0 0 0 0]');
...
if isa( this.clutter, 'poisclut1' )
    ...
    [cout]  = this.clutter.getclutter( this.alpha*2, this.maxrange  );
    if ~isempty(cout)
        cbearing = cout{1};
        crange = cout{2};
