    ...
    while 1     %loop untill convergence
        ...
        if plotFlag
            figure(12345),clf,hold on
                ...
                if numDim>=4
                figure(54321),clf,hold on
            
                plot(dataPts(3,:),dataPts(4,:),'.')
                plot(dataPts(3,myMembers),dataPts(4,myMembers),'ys')
                plot(myMean(3),myMean(4),'go')
                plot(myOldMean(3),myOldMean(4),'rd')
