...
if printFigure2files
  ...
  %      get(gca, 'TightInset') * [-1 0 1 0; 0 -1 0 1; 0 0 1 0; 0 0 0 1]);
   ...
   set( gcf, 'PaperPosition', myFigureSize)
    ...
    print( gcf, '-dpng', ['quad_hbounds2','.png'])
    print( gcf, '-depsc2', ['quad_hbounds2','.eps'])
end
...
if printFigure2files
  ...
  %      get(gca, 'TightInset') * [-1 0 1 0; 0 -1 0 1; 0 0 1 0; 0 0 0 1]);
   ...
   set( gcf, 'PaperPosition', myFigureSize)
    ...
    print( gcf, '-dpng', ['quad_ibounds2','.png'])
    print( gcf, '-depsc2', ['quad_ibounds2','.eps'])
end
...
if printFigure2files
  ...
  %      get(gca, 'TightInset') * [-1 0 1 0; 0 -1 0 1; 0 0 1 0; 0 0 0 1]);
   ...
   set( gcf, 'PaperPosition', myFigureSize)
    ...
    print( gcf, '-dpng', ['d_quads2','.png'])
    print( gcf, '-depsc2', ['d_quads2','.eps'])
end
