...
for j = 1:height
    ...
    for k = 1:width
        ...
        lm1 = mean(mean(l(y11:y12,x11:x12)));am1 = mean(mean(a(y11:y12,x11:x12)));bm1 = mean(mean(b(y11:y12,x11:x12)));
        lm2 = mean(mean(l(y21:y22,x21:x22)));am2 = mean(mean(a(y21:y22,x21:x22)));bm2 = mean(mean(b(y21:y22,x21:x22)));
        lm3 = mean(mean(l(y31:y32,x31:x32)));am3 = mean(mean(a(y31:y32,x31:x32)));bm3 = mean(mean(b(y31:y32,x31:x32)));
        %---------------------------------------------------------
