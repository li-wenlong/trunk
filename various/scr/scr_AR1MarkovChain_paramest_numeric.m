...
hold on
plot(d_quad)
plot(i_bound_condkld,'r')
plot(i_bound,'g')
plot(i_bound_hdiff,'m')
...
for k=1:t
    ...
    h_bound(k) = 0.5*( Hjpred - Hcpred + Hipred - Hcpred ) + 0.5*( Hjpost - Hcpostzj + Hipost - C_xGzik_allhist  );
